...
<div class="container-fluid" style="margin-left:240px; margin-top:115px">     
  <div class="col-lg-9 col-xl-7 col-md-7">
    <div class="card">
      <div class="card-body">
        <center style="font-size:2rem;">Update a  user</center>
        <div class="row mt-4">
              <div class="col-12">
                <form class="form-horizontal" action="{{ route('users.update',$user->id) }}" method="post" id="createUser" novalidate>
                    @csrf
                    @method('PUT')
                <div style="display:flex; gap:1%">
                  <div class="form-floating mb-3" style="width:50%;">
                    <input type="text" class="form-control form-input-bg" id="tb-rfname" placeholder="john deo" required name="name" value ="{{$user->name}}"/>
                    <label for="tb-rfname">Full Name</label>
                    <div class="invalid-feedback">Full name is required</div>
                  </div>
                  <div class="form-floating mb-3" style="width:50%;">
                    <input type="email" class="form-control form-input-bg" id="tb-remail" placeholder="john@gmail.com" required name="email" value ="{{$user->email}}"/>
                ...
                <div style="display:flex; gap:1%">
                  <div class="form-floating mb-3" style="width:50%;">
                    <input type="text" class="form-control form-input-bg" id="tb-rphone" placeholder="+123423654" required name="phoneNo" value ="{{$user->phoneNo}}"/>
                    <label for="tb-rphone">Phone No.</label>
                    <div class="invalid-feedback">Phone No. is required</div>
                  </div>
                  <div class="form-floating mb-3" style="width:50%;">
                    <input type="password" class="form-control form-input-bg" id="text-rpassword" placeholder="*****" required name="password" value ="{{$user->password}}"/>
